 ...
 * Author: VINAYAK
 *
 * Created on 3 May, 2025, 12:32 AM
 */
...
void main(void) {
    ...
    /* log of initial state of car event and the speed in the EEprom*/
    ...
    while (1) {
        ...
        if (key == ALL_RELEASED)
        {
            ...
            {
                if (pre_key == SW1 && strcmp(event, "CO "))     //For collision
                {
                    strcpy(event, "CO ");
                    log_car_event(event, speed);
                    pre_key = press = 0;
                ...
                else if (pre_key == SW2 && gr < 6)   //For increasing gear
                {
                ...
                else if (pre_key == SW3 && gr > 0)   //For decreasing gear
                {
                    gr--;
                    strcpy(event, gear[gr]);
                    log_car_event(event, speed);
